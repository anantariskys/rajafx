    ...
    >
      ...
      >
        ...
        <div className="absolute flex w-full  flex-col md:gap-8 gap-2 items-center justify-center">
           {pathname === "/xm/jenis-akun" || pathname.startsWith("/valetax/jenis-akun/")? (
            <>
              <p className="md:text-5xl text-xl font-semibold text-center md:max-w-4xl">Ingin mencoba simulasi trading?</p>
              <p>
                Mulai demo trading untuk mendapatkan simulasi dan uji strategi
                trading dengan dana virtual
              </p>
            </>
          ) : (
